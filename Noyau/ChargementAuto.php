...
final class ChargementAuto
{
    ...
    public static function chargerClassesMapper ($S_nomDeClasse)
    {
        $S_fichier = Constantes::repertoireMappers() . "$S_nomDeClasse.php";
    ...
    public static function chargerClassesTest ($S_nomDeClasse)
    {
        $S_fichier = Constantes::repertoireTests() . "$S_nomDeClasse.php";
...
spl_autoload_register('ChargementAuto::chargerClassesTest');
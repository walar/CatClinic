...
?>
<h1>Supprimer l'auteur' "<?php echo $O_auteur->donneNom() . ' ' . $O_auteur->donnePrenom(); ?>"</h1>
<form name="auteur"
      id="auteur"
      method="post"
    ...
    <div id="corpForm">
        <p>
            Êtes-vous sur de vouloir supprimer l'auteur "<?php echo $O_auteur->donneNom() . ' ' . $O_auteur->donnePrenom(); ?>" ? <br />
